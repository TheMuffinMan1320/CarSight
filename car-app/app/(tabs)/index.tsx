...
export default function HomeScreen() {
	return (
		<ParallaxScrollView
			...
			headerImage={
				<Image source={require("@/assets/images/IMG_6098.jpg")} style={styles.reactLogo} />
			}
		>
			<ThemedView style={styles.titleContainer}>
				<ThemedText type="title">CarSight</ThemedText>
			</ThemedView>
			...
			<ThemedView style={styles.stepContainer}>
				<Link href="/modal">
					<Link.Trigger>
						<ThemedText type="subtitle">Hello: Explore</ThemedText>
					</Link.Trigger>
					<Link.Preview />
					<Link.Menu>
						<Link.MenuAction
